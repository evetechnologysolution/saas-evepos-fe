...
export default function ProfitLoss() {
  ...
  useEffect(() => {
    ...
    const tOtherCost =
      (data?.tax || 0) +
      (data?.expenses?.code1 || 0) +
      (data?.expenses?.code2 || 0) +
      (data?.expenses?.code3 || 0) +
      (data?.expenses?.code4 || 0) +
      (data?.expenses?.code5 || 0) +
      (data?.expenses?.code6 || 0) +
      (data?.expenses?.code7 || 0) +
      (data?.expenses?.code8 || 0);
  ...
  return (
    <Page title="Profit Loss" sx={{ height: 1 }}>
      <Container maxWidth="xl">
        <HeaderBreadcrumbs heading="Profit Loss" links={[]} />
            ...
            <Grid item xs="auto" md={6}>
              <Stack flexDirection={{ sm: 'row' }} justifyContent="space-between" gap={1}>
                ...
                <Stack flexDirection="row">
                  {period !== '-' ? (
                    <PDFDownloadLink
                      document={<MyPDF period={period} data={data} />}
                      fileName={`Laba Rugi ${period}.pdf`}
                    >
                      {({ loading }) => (
                        <Button variant="contained" color="info" title="Export" sx={{ minWidth: 130 }}>
                          <Iconify icon={'material-symbols:download-rounded'} sx={{ width: 25, height: 25, mr: 0.5 }} />
            ...
            <Grid item xs={12}>
              ...
              <Stack justifyContent="space-between" p={2} gap={3}>
                ...
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  ...
                  <Typography variant="body2" color="#637381">
                    Rp. {numberWithCommas(fDecimal(data?.sales || 0))}
                  </Typography>
                </Stack>
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  <Typography variant="body2" color="#637381">
                  ...
                  <Typography variant="body2" color="#637381">
                    (Rp. {numberWithCommas(fDecimal(data?.discount || 0))})
                  </Typography>
                </Stack>
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  <Typography variant="body2" color="#637381">{`Pengembalian Dana (Refund)`}</Typography>
                  <Typography variant="body2" color="#637381">
                    (Rp. {numberWithCommas(fDecimal(data?.refund || 0))})
                  </Typography>
                </Stack>
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  <Typography variant="body2" color="#637381">
                  ...
                  <Typography variant="subtitle2" color="#637381">
                    Rp. {numberWithCommas(fDecimal(totalSales))}
                  </Typography>
                </Stack>
              </Stack>
              ...
              <Stack justifyContent="space-between" p={2} gap={3}>
                ...
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  ...
                  <Typography variant="subtitle2" color="#637381">
                    (Rp. {numberWithCommas(fDecimal(data?.productionCost || 0))})
                  </Typography>
                </Stack>
              </Stack>
              ...
              >
                ...
                <Typography variant="subtitle2" color="#637381">
                  Rp. {numberWithCommas(fDecimal(gorssProfit))}
                </Typography>
              </Stack>
              ...
              <Stack justifyContent="space-between" p={2} gap={3}>
                ...
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  ...
                  <Typography variant="body2" color="#637381">
                    Rp. {numberWithCommas(fDecimal(data?.tax || 0))}
                  </Typography>
                </Stack>
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  <Typography variant="body2" color="#637381">
                  ...
                  <Typography variant="body2" color="#637381">
                    Rp. {numberWithCommas(fDecimal(data?.expenses?.code1 || 0))}
                  </Typography>
                </Stack>
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  <Typography variant="body2" color="#637381">
                  ...
                  <Typography variant="body2" color="#637381">
                    Rp. {numberWithCommas(fDecimal(data?.expenses?.code2 || 0))}
                  </Typography>
                </Stack>
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  <Typography variant="body2" color="#637381">
                  ...
                  <Typography variant="body2" color="#637381">
                    Rp. {numberWithCommas(fDecimal(data?.expenses?.code3 || 0))}
                  </Typography>
                </Stack>
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  <Typography variant="body2" color="#637381">
                  ...
                  <Typography variant="body2" color="#637381">
                    Rp. {numberWithCommas(fDecimal(data?.expenses?.code4 || 0))}
                  </Typography>
                </Stack>
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  <Typography variant="body2" color="#637381">
                  ...
                  <Typography variant="body2" color="#637381">
                    Rp. {numberWithCommas(fDecimal(data?.expenses?.code5 || 0))}
                  </Typography>
                </Stack>
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  <Typography variant="body2" color="#637381">
                  ...
                  <Typography variant="body2" color="#637381">
                    Rp. {numberWithCommas(fDecimal(data?.expenses?.code6 || 0))}
                  </Typography>
                </Stack>
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  <Typography variant="body2" color="#637381">
                  ...
                  <Typography variant="body2" color="#637381">
                    Rp. {numberWithCommas(fDecimal(data?.expenses?.code7 || 0))}
                  </Typography>
                </Stack>
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  <Typography variant="body2" color="#637381">
                  ...
                  <Typography variant="body2" color="#637381">
                    Rp. {numberWithCommas(fDecimal(data?.expenses?.code8 || 0))}
                  </Typography>
                </Stack>
              </Stack>
              ...
              <Stack flexDirection="row" justifyContent="space-between" p={2} gap={3}>
                ...
                <Typography variant="subtitle2" color="#637381">
                  Rp. {numberWithCommas(fDecimal(otherCost))}
                </Typography>
              </Stack>
              ...
              >
                ...
                <Typography variant="subtitle2" color="#637381">
                  Rp. {numberWithCommas(fDecimal(operationalProfit))}
                </Typography>
              </Stack>
              ...
              <Stack justifyContent="space-between" p={2} gap={3}>
                ...
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  ...
                  <Typography variant="body2" color="#637381">
                    Rp. {numberWithCommas(fDecimal(data?.serviceCharge || 0))}
                  </Typography>
                </Stack>
                <Stack flexDirection="row" justifyContent="space-between" ml={{ md: 5 }}>
                  <Typography variant="body2" color="#637381">
                  ...
                  <Typography variant="body2" color="#637381">
                    Rp. {numberWithCommas(fDecimal(data?.deliveryPrice || 0))}
                  </Typography>
                </Stack>
              </Stack>
              ...
              <Stack flexDirection="row" justifyContent="space-between" p={2} gap={3}>
                ...
                <Typography variant="subtitle2" color="#637381">
                  Rp. {numberWithCommas(fDecimal(otherIncome))}
                </Typography>
              </Stack>
              ...
              >
                ...
                <Typography variant="subtitle2" color="#637381">
                  Rp. {numberWithCommas(fDecimal(netProfit))}
                </Typography>
              </Stack>
              <Divider sx={{ mx: '10px' }} />
            </Grid>
