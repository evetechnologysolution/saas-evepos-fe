        ...
        <>
            <Box sx={{ alignItems: "center" }}>
                ...
                <Stack flexDirection="row" justifyContent="center" alignItems="center">
                    ...
                    <IconButton
                        color="primary"
                        disabled={page + 1 === Math.ceil(products.length / rowsPerPage) || products.length <= rowsPerPage ? Boolean(true) : Boolean(false)}
                        onClick={() => setPage(page + 1)}
                    >
                        <Iconify
                            ...
                            width={24}
                            height={24}
                            sx={{ color: page + 1 === Math.ceil(products.length / rowsPerPage) || products.length <= rowsPerPage ? "transparent" : "inherit" }}
                        />
                    </IconButton>
                </Stack>
            </Box>
