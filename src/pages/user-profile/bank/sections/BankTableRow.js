...
export default function BankTableRow({ row, onEditRow, onDeleteRow }) {
  const theme = useTheme();

  const { user } = useAuth();

  const { createdAt, bankName, accountNumber, accountHolderName, isActive } = row;
  ...
  return (
    <CustomTableRow hover>
      ...
      <TableCell align="left">{accountHolderName}</TableCell>
