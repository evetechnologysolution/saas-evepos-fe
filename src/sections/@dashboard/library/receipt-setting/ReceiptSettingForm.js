...
// service
import useReceiptSetting from './service/useReceiptSetting';
                    ...
                    <table>
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <Typography variant="body2">: {formatOnlyDate(new Date())}</Typography>
                          </td>
                        </tr>
                        <tr>
                          <td>
                          ...
                          <td>
                            <Typography variant="body2">: ORD0000000132</Typography>
                          </td>
                        </tr>
                      </tbody>
                    </table>
