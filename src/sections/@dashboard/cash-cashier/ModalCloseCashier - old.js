        ...
        <DialogContent dividers>
          <Grid container spacing={3} mb={3}>
            ...
            <Grid item xs={6}>
              {/* <Box p={2} borderRadius="8px" bgcolor="#F28A30" color="white"> */}
              <Box p={2} borderRadius="8px" bgcolor="#673AB7" color="white">
                <Typography variant="body1">E-Wallet</Typography>
                <Typography variant="h6" align="center">
          ...
          <Typography variant="subtitle2">Input nominal untuk menarik uang kas</Typography>
          <FormGroup sx={{ mb: 1 }}>
            <FormControlLabel control={<Checkbox checked={checked} onChange={handleChecked} />} label="Tarik Semua" />
          </FormGroup>
          <NumericFormat
