...
export default function ModalCloseCashier({ open, handleClose, handleCloseCashier }) {
    ...
    if (ctx.existCash?.detail) {
        const eWallet = ctx.existCash?.detail?.dana + ctx.existCash?.detail?.ovo + ctx.existCash?.detail?.shopeePay + ctx.existCash?.detail?.qris;
        const card = ctx.existCash?.detail?.bri + ctx.existCash?.detail?.bni + ctx.existCash?.detail?.bca + ctx.existCash?.detail?.mandiri;
