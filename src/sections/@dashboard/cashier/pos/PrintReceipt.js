...
const PrintReceipt = React.forwardRef(({ bill, status = "paid" }, ref) => {
    ...
    useEffect(() => {
        ...
        ctx.setActualPrice(((sumPrice + serviceAmount + taxAmount) - ctx.voucherDiscPrice - ctx.discountPrice) + ctx.deliveryPrice);
    }, [bill]);
                            ...
                            <React.Fragment key={i}>
                                ...
                                <tr>
                                    <td style={{ textAlign: "left" }}>
                                        {`${item.qty}${item?.category?.toLowerCase() === "kiloan" ? "kg" : ""} x Rp. ${numberWithCommas(originPrice)}`}
                                    </td>
                                    <td style={{
                                        textAlign: "right",
                    ...
                    {ctx.discountPrice > 0 && (
                        <tr>
                            <td style={{ textAlign: "left" }}>
                                ...
                                {ctx?.discountLabel ? (
                                    <p style={{ fontSize: "8px" }}>{`(${ctx.discountLabel})`}</p>
                                ) : null}
                            </td>
            ...
            <table style={{ width: "100%" }}>
                <tbody>
                    ...
                    {status?.toLowerCase() === "paid" && (
                        <>
                            <tr>
                                ...
                                <td style={{ textAlign: "right" }}>
                                    Rp. {numberWithCommas(ctx.amountPaid)}
                                </td>
                            </tr>
                            <tr>
                    ...
                    <tr>
                        ...
                        <td style={{ textAlign: "right" }}>
                            {status?.toLowerCase() === "paid" ? "Lunas" : "Belum Lunas"}
                        </td>
                    </tr>
                </tbody>
            </table>
