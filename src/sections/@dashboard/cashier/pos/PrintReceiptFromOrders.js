...
const PrintReceiptFromOrders = React.forwardRef(({ data }, ref) => {
    ...
    return (
        <div ref={ref} className="no-break">
            ...
            {ctm.receiptHeader?.web && (
                <p style={{ fontSize: "11px" }}>{ctm.receiptHeader?.web}</p>
            )}
                            ...
                            <React.Fragment key={i}>
                                ...
                                <tr>
                                    <td style={{ textAlign: "left" }}>
                                        {`${item.qty}${item?.category?.toLowerCase() === "kiloan" ? "kg" : ""} x ${numberWithCommas(originPrice)}`}
                                    </td>
                                    <td style={{
                                        textAlign: "right",
            ...
            <table style={{ width: "100%" }}>
                <tbody>
                    {data.serviceCharge > 0 && (
                        <tr>
                            <td style={{ textAlign: "left" }}>
                                Biaya Jasa ({data.serviceChargePercentage}%)
                            </td>
                            <td style={{ textAlign: "right" }}>
                                Rp. {numberWithCommas(data.serviceCharge)}
                            </td>
                        </tr>
                    )}
                    ...
                    {data.voucherDiscPrice > 0 && (
                        <tr>
                            ...
                            <td style={{ textAlign: "right" }}>
                                -Rp. {numberWithCommas(data.voucherDiscPrice)}
                            </td>
                        </tr>
                    )}
                    ...
                    {data.discountPrice > 0 && (
                        <tr>
                            <td style={{ textAlign: "left" }}>
                                ...
                                {data?.discountLabel ? (
                                    <p style={{ fontSize: "8px" }}>{`(${data.discountLabel})`}</p>
                                ) : null}
                            </td>
                            <td style={{ textAlign: "right" }}>
                                -Rp. {numberWithCommas(data.discountPrice)}
                            </td>
                        </tr>
                    )}
                    ...
                    {data.deliveryPrice > 0 && (
                        <tr>
                            ...
                            <td style={{ textAlign: "right" }}>
                                Rp. {numberWithCommas(data.deliveryPrice)}
                            </td>
                        </tr>
                    )}
                        ...
                        <tbody>
                            ...
                            {data.donation > 0 && (
                                <tr>
                                    ...
                                    <td style={{ textAlign: "right" }}>
                                        Rp. {numberWithCommas(data.donation)}
                                    </td>
                                </tr>
                            )}
                        </tbody>
            ...
            <table style={{ width: "100%" }} className="no-break">
                <tbody>
                    <tr>
                        ...
                        <td style={{ textAlign: "right" }}>
                            {data.status?.toLowerCase() === "paid" ? "Lunas" : "Belum Lunas"}
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            {ctm.receiptHeader.notes && (
                <table style={{ width: "100%", fontSize: "8px", marginBottom: "10px" }}>
                    <tbody>
                        <tr>
                            <td style={{ textAlign: "left" }}>
                                {newLineText(ctm.receiptHeader.notes)}
                            </td>
                        </tr>
                    </tbody>
                </table>
